...
class GPC_DFTB(FileIOCalculator):
    ...
    def __init__(self, restart=None, ignore_bad_restart_file=False,
                 ...
                 run_manyDftb_steps=False, slako_dir='./', gp_fpath='./GAP.xml',
                 **kwargs):
    ...
    def calculate(self, atoms=None, properties=['energy'],
        ...
        atomic_free_energies = {
            'C': -38.4154,
            'O': -84.6094,
            'Pt': -63.8686,
            }

        for sym in atoms_gap.get_chemical_symbols():
            self.results['energy'] -= atomic_energies[sym]
            self.results['free_energy'] -= atomic_free_energies[sym]
