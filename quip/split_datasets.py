...
if __name__ == '__main__':
    ...
    for idx in train_indices:
        frame_step = total_frames[idx].info['step']
        if frame_step in [27,78,79,140,141]:
            print(frame_step)
            continue
    ...
    ase.io.write('vasp_train.xyz', train_frames)
    ase.io.write('vasp_valid.xyz', valid_frames)

    #total_frames = ase.io.read("../../../dataset/sampled_structures-3309.xyz", ':')
    #train_frames, valid_frames = [], []
    #for idx in train_indices:
    #    frame_step = total_frames[idx].info['step']
    #    if frame_step in [27,78,79,140,141]:
